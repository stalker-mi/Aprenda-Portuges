...
:: Android packaging
set AND_CERT_NAME="Appenda portuges"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Appendaportuges.p12
...
set IOS_PROVISION=cert\Appendaportuges.mobileprovision
