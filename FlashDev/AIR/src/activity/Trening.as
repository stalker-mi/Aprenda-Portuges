...
import starling.display.Quad;
	...
	public class Trening extends Sprite {
		...
		public function Trening() {
			...
			arr1.push("Amor","Madrugada","Aguerido","Fazer Amor","Saudade","Ocoracao");
			arr1.push("Pegar", "Pegaronda");
			
			var arr2:Vector.<String> = new Vector.<String>;
			arr2.push("Сердце","Любовь","Ловить волну", "Рассвет", "Заниматься любовью");
			arr2.push("Дорогой", "Скука", "Ксюша не знает");
			
			var words:Words = new Words(arr1,arr2);
